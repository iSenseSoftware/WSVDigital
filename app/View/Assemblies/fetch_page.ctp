                            ...
                            <tbody>
                                <? foreach ($assembly as $anAssembly) { ?>
                                    <tr>
                                        ...
                                        <td><a href="#top<? echo $anAssembly['ModelID']; ?>Rev<? echo $anAssembly['ComponentRevision']; ?>" name="top<? echo $anAssembly['ModelID']; ?>Rev<? echo $anAssembly['ComponentRevision']; ?>" offset="0" class="assembly" modelId="<? echo $anAssembly['ModelID']; ?>" rev="<? echo $anAssembly['ComponentRevision']; ?>">
